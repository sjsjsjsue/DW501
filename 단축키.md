...
- import 하는 법
  - spring initiallizr > 내가 원하는 것 클릭 > 파일 다운로드 > 파일 알집 풀기 > 이클립스 들어가기 > file > import > next > 브라우저 클릭 > next > finish
- PI 삭제...? (서버 여러번 뜨는 거 삭제)
  - netstat -a -o > 8800 > taskkill /F /PID PID값
